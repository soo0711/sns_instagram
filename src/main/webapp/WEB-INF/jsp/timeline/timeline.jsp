		...
		<div class="w-50 d-flex justify-content-center">
			<div>
				...
				<div class="border p-2">
					<textarea cols="100" rows="4" class="border-0"> 내용을 입력해주세요.</textarea>
				...
				<div class="border mt-5">
					...
					<img src="/static/img/street.jpg" alt="사진" class="w-100 p-3">
					...
					<div class="ml-4 snsIdCss d-flex align-items-center">
						<span class="mr-2 font-weight-bold">marbonia</span>
						<span>비지도 학습을 한 결과입니다.</span>
					</div>
					...
					<div class="border-top d-flex justify-content-between pl-2">
						<input type="text" placeholder="댓글 달기" class="border-0 col-10">
